...
export default function NonvegthaliDetails()
{
    ...
    return (
      ...
      <div >
      <h1>Kolkata biryani<img width="60" src="https://sukhis.com/wp-content/uploads/2019/08/S94A9780-2.jpg"></img></h1>
...
<Rating
  ...
  />
       ...
       <br/>
        <h1> Memoni biryani<img width="100" src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/ajd2fd7if56y42be9bea"></img></h1>
      <div className="wrapper">
      <div className="name">
...
<Rating
  ...
  />
        ...
        <br/>
        <h1>Mughlai Biryani<img  width="70" src="https://c.ndtvimg.com/2020-02/c65pekt8_biryani_625x300_03_February_20.jpg"></img></h1>
      <div className="wrapper">
      <div className="name">
