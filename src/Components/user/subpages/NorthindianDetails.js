...
export default function NonvegthaliDetails()
{
    ...
    return (
      ...
      <div >
      <h1>Butter Chicken<img width="60" src="https://www.licious.in/blog/wp-content/uploads/2020/10/butter-chicken-.jpg"></img></h1>
...
<Rating
  ...
  />
       ...
       <br/>
        <h1>Palak Paneer<img width="100" src="https://s3.amazonaws.com/images.chefinyou.com/main/opos-palak-paneer-recipe/main-img4.JPG"></img></h1>
      <div className="wrapper">
      <div className="name">
...
<Rating
  ...
  />
        ...
        <br/>
        <h1>Amritsari Chole Bhature<img  width="70" src="https://spicedpeachblog.com/wp-content/uploads/2018/09/IMG_5730-2.jpg"></img></h1>
      <div className="wrapper">
      <div className="name">
