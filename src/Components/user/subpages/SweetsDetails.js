...
export default function NonvegthaliDetails()
{
    ...
    return (
      ...
      <div >
      <h1>Rasgulla<img width="60" src="https://www.thespruceeats.com/thmb/KwH6Wwpz_BoM2VEXrXJwC_3RIp8=/960x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/rasgulla-indian-dessert-1957839-hero-01-7c3528a2d34a4f1b9248c7483a73d0a6.jpg"></img></h1>
...
<Rating
  ...
  />
       ...
       <br/>
        <h1>Kaju Katli<img width="100" src="https://cdn.shopify.com/s/files/1/1797/4963/products/kaju_katli_673d5141-2629-4ef2-bea0-8293490e3bd1_638x462.jpg?v=1573897891"></img></h1>
      <div className="wrapper">
      <div className="name">
...
<Rating
  ...
  />
        ...
        <br/>
        <h1>Jalebi<img  width="70" src="https://recipesbrand.com/wp-content/uploads/2020/09/Easy-Crispy-Jalebi-Recipe-at-Home.jpg"></img></h1>
      <div className="wrapper">
      <div className="name">
