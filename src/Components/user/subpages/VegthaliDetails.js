...
export default function VegthaliDetails()
{
    const [value, setValue] = React.useState(4);
    return (
      
      <div >
      <h1>Rajasthani Thali <img width="60" src="https://img.theculturetrip.com/768x/smart/wp-content/uploads/2018/02/rajasthani-thali-1.jpg"></img></h1>
...
<Rating
  ...
  />
       ...
       <br/>
        <h1>Bengali Thali<img width="100" src="https://img.theculturetrip.com/768x/smart/wp-content/uploads/2018/02/bengali-thali.jpg"></img></h1>
      <div className="wrapper">
      <div className="name">
...
<Rating
  ...
  />
        ...
        <br/>
        <h1>Kashmiri Thali<img  width="70" src="https://static.toiimg.com/photo/62250623/.jpg "></img></h1>
      <div className="wrapper">
      <div className="name">
